...
**JSF** is a JavaScript parser for the **Ceedoku Save Format (CSF)**.
...
JSF is designed to work with **FSJ**, the CSF serializer.
...
A CSF file generated by a compliant FSJ implementation can be parsed by a compliant JSF implementation.
...
JSF is an implementation of the **Ceedoku Save Format (CSF)** specification.
